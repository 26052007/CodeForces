...
 
        // Check factors using the 6k +/- 1 rule up to sqrt(num)
...
 
        // If candidate is even and greater than 2, make it odd to skip even numbers
        if (candidate % 2 == 0) {
            candidate++;
        }
 
        // Linearly scan odd numbers until a prime is found
